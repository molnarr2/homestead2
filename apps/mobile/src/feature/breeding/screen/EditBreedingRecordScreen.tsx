...
const EditBreedingRecordScreen: React.FC = () => {
  const navigation = useNavigation<Navigation>()
  const route = useRoute<Route>()
  const c = useEditBreedingRecordController(navigation, route)
  ...
  return (
    <ScreenContainer>
      <View className="flex-row items-center justify-between px-4 pt-4 pb-2">
        ...
        <Text className="text-xl font-bold text-text-primary">Edit Breeding Record</Text>
        <View className="w-8" />
      </View>
