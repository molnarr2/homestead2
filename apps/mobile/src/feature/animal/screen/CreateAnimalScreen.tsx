...
import { useCreateAnimalController } from './CreateAnimalController'
...
import { AnimalGender } from '../../../schema/animal/Animal'
...
const CreateAnimalScreen: React.FC = () => {
  const navigation = useNavigation<Navigation>()
  const route = useRoute<Route>()
  const controller = useCreateAnimalController(navigation, route)
  ...
  return (
    <ScreenContainer>
      <View className="flex-row items-center justify-between px-4 pt-4 pb-2">
        ...
        <Text className="text-xl font-bold text-text-primary">Add Animal</Text>
        <View className="w-8" />
      </View>
        ...
        >
          {controller.photoUri ? (
            ...
            <View className="items-center">
              <Icon name="camera-plus" size={28} color="#6B5B52" />
